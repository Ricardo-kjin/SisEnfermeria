...
<form method="POST" action="/insumos" enctype="multipart/form-data">
    @csrf {{-- csrf_field() --}}
    ...
    <div class="form-group">
        ...
        <input type="number" name="precio" class="form-control col-md-6" id="precio" placeholder="Nombre..." value="{{ old('Precio') }}">
    </div>
    <div class="form-group">

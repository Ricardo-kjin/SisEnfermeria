...
@section('content')
    ...
    <form method="POST" action="/users" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <input type="tipo_usuario" name="tipo_usuario" class="form-control" id="tipo_usuario" placeholder="Tipo de usuario..." value="{{ old('tipo_usuario') }}">
        </div>
        <div class="form-group">
    ...
    <script>
        $(document).ready(function(){
            ...
            permissions_box.hide(); // hide all boxes esconde el permissions_box
            $('#role').on('change', function() {
                ...
                $.ajax({
                    ...
                    $.each(data, function(index, element){
                        $(permissions_ckeckbox_list).append( //append significa uno despues de otro

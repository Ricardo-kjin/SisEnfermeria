...
<form method="POST" action="/roles/{{$role->id}}">
    ...
    <div class="form-group" >
        <label for="roles_permisos">Add permisos</label>
        <input type="text" data-role="tagsinput" name="roles_permisos" class="form-control" id="roles_permisos" value="@foreach ($role->permisos as $permiso)
            {{$permiso->name. ","}}
        @endforeach">
    </div>

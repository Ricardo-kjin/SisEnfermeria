...
<form method="POST" action="/roles">
    ...
    <div class="form-group" >
        <label for="role_permisos">Add Permissions</label>
        <input type="text" data-role="tagsinput" name="role_permisos" class="form-control" id="role_permisos" value="{{ old('role_permisos') }}">
    </div>
